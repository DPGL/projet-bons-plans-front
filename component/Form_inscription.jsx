...
function Inscription() {
  ...
  const initialValues = {lastname: "", firstname: "", email: "", password: "", confirmPassword: "", age: "", username: "", ecole: "", formation: ""};
    ...
    return (
      <form className="Form_inscription" onSubmit={submit}>
        <div className="container_inscription">
          ...
          <input type="text" name="lastname" placeholder="Nom" value={formValues.nom} onChange={handleChange}/>
          <input type="text" name="firstname" placeholder="Prénom" value={formValues.prenom} onChange={handleChange}/>
